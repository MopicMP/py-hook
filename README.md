...
> Pre/post function hooks and middleware

[![PyPI version](https://badge.fury.io/py/py-hook.svg)](https://pypi.org/project/py-hook/)
...
result = hook("Hello World")

# Example 2: Batch processing
from py_hook import batch
